...
public class Get17 extends GMIBankBaseUrl{
    /*
        Given
    ...
    public void get17(){
        ...
        //Do Assertion
        Customer actualData = JsonUtils.convertJsonToJava(response.asString(), Customer.class);
        ...
        assertEquals(country.getId(), actualData.country.getId());
        assertEquals(country.getName(), actualData.country.getName());
        assertEquals(country.getStates(), actualData.country.getStates());
        assertEquals(expectedData.getState(), actualData.getState());
        assertEquals(user.getId(), actualData.user.getId());
        assertEquals(user.getLogin(), actualData.user.getLogin());
        assertEquals(user.getFirstName(), actualData.user.getFirstName());
        assertEquals(user.getLastName(), actualData.user.getLastName());
        assertEquals(user.getEmail(), actualData.user.getEmail());
        assertEquals(user.isActivated(), actualData.user.isActivated());
        assertEquals(user.getLangKey(), actualData.user.getLangKey());
        assertEquals(user.getImageUrl(), actualData.user.getImageUrl());
        assertEquals(user.getResetDate(), actualData.user.getResetDate());
